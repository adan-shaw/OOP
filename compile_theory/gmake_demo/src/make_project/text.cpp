//测试1: (测试跨越性调用)
#include "../no_assert/make_project.h"
void printfxx(void){
...
//测试2: (测试静态库函数调用)
extern "C"{
#include "../lib_static/headfile/lib_static.h"
#include "../lib_static/headfile/lib_static2.h"
}
...
//测试3: (测试动态库函数调用)
#include "../lib_dynamic/headfile/lib_dynamic.h"
