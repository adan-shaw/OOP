...
#include <stdbool.h>
extern "C"{
  #include "../../WjCryptLib-master/lib/WjCryptLib_AesCbc.h"
  #include "../../WjCryptLib-master/lib/WjCryptLib_Sha1.h"
  #include "../../WjCryptLib-master/lib/WjCryptLib_Rc4.h"
  #include "../headfile/WjCryptLibTest_AesCbc.h"//必须要包含自己的头文件做索引, 才能编译出来Test_AesCbc()
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  MACROS
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//(stdin)= 859463d3f0f27e67d37f05603f19b9d5c71c2059
    ...
    uint8_t*        buffer = (uint8_t*)malloc( numBytesToGenerate );
    uint8_t*        buffer2 = (uint8_t*)malloc( numBytesToGenerate );
    ...
    )
{
    ...
    printf( "--TestVectors() - %s\n", totalSuccess?"Pass":"Fail" );
