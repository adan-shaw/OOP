...
.LC2:
	...
	.align 8
.LC3:
	.string	"Invalid IV size. Must be 64 bits"
.LC4:
	.string	"%2.2x"
	.text
	.globl	_Z12AesCtrOutputiPPc
	.type	_Z12AesCtrOutputiPPc, @function
_Z12AesCtrOutputiPPc:
.LFB7:
	.loc 1 91 0
	.cfi_startproc
	pushq	%rbp
...
.L14:
	...
	leaq	-1568(%rbp), %rax
	movq	%rax, %rdi
	call	AesCtrInitialiseWithKey@PLT
	.loc 1 132 0
	movl	-12(%rbp), %eax
	movl	%eax, -8(%rbp)
.L18:
...
.L19:
	...
	.cfi_endproc
.LFE7:
	.size	_Z12AesCtrOutputiPPc, .-_Z12AesCtrOutputiPPc
.Letext0:
	...
	.file 13 "../WjCryptLib-master/lib/WjCryptLib_AesCtr.h"
	.file 14 "<built-in>"
...
.LASF1301:
	.string	"CurrentCipherBlockIndex"
.LASF589:
