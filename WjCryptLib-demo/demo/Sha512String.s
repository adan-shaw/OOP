...
.LC1:
	.string	"%2.2x"
	.text
	.globl	_Z12Sha512StringiPPc
	.type	_Z12Sha512StringiPPc, @function
_Z12Sha512StringiPPc:
.LFB6:
	.file 1 "./src/Sha512String.cpp"
	.loc 1 29 0
	.cfi_startproc
	pushq	%rbp
...
.L2:
	...
	movq	%rcx, %rsi
	movq	%rax, %rdi
	call	Sha512Update@PLT
	.loc 1 47 0
	leaq	-288(%rbp), %rdx
	leaq	-224(%rbp), %rax
	movq	%rdx, %rsi
	movq	%rax, %rdi
	call	Sha512Finalise@PLT
	.loc 1 49 0
	movw	$0, -2(%rbp)
.L5:
...
.L6:
	...
	.cfi_endproc
.LFE6:
	.size	_Z12Sha512StringiPPc, .-_Z12Sha512StringiPPc
.Letext0:
	...
	.file 12 "../WjCryptLib-master/lib/WjCryptLib_Sha512.h"
	.file 13 "<built-in>"
