...
.LC3:
	...
	.align 8
.LC4:
	.string	"Invalid block size, must be 128 bits (was %u bits)\n"
	.align 8
.LC5:
	.string	"Invalid key size, must be 128, 192, or 256 bits (was %u bits)\n"
.LC6:
	.string	"%2.2x"
	.text
	.globl	_Z12AesBlockDemoiPPc
	.type	_Z12AesBlockDemoiPPc, @function
_Z12AesBlockDemoiPPc:
.LFB7:
	.loc 1 87 0
	.cfi_startproc
	pushq	%rbp
...
.L30:
	...
	.cfi_endproc
.LFE7:
	.size	_Z12AesBlockDemoiPPc, .-_Z12AesBlockDemoiPPc
.Letext0:
...
.Ldebug_macro0:
	...
	.long	.Ldebug_macro57
	.byte	0x4
	.file 47 "/usr/lib/gcc/x86_64-linux-gnu/6/include/stdbool.h"
	.byte	0x3
	.uleb128 0x12
	.uleb128 0x2f
	.byte	0x7
...
.LASF1219:
	.string	"StringCaseInsensitiveCmp strcasecmp"
.LASF1033:
