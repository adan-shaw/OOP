...
.LC1:
	.string	"%2.2x"
	.text
	.globl	_Z12Sha256StringiPPc
	.type	_Z12Sha256StringiPPc, @function
_Z12Sha256StringiPPc:
.LFB6:
	.file 1 "./src/Sha256String.cpp"
	.loc 1 29 0
	.cfi_startproc
	pushq	%rbp
...
.L2:
	...
	movq	%rcx, %rsi
	movq	%rax, %rdi
	call	Sha256Update@PLT
	.loc 1 47 0
	leaq	-160(%rbp), %rdx
	leaq	-128(%rbp), %rax
	movq	%rdx, %rsi
	movq	%rax, %rdi
	call	Sha256Finalise@PLT
	.loc 1 49 0
	movw	$0, -2(%rbp)
.L5:
...
.L6:
	...
	.cfi_endproc
.LFE6:
	.size	_Z12Sha256StringiPPc, .-_Z12Sha256StringiPPc
.Letext0:
	...
	.file 12 "../WjCryptLib-master/lib/WjCryptLib_Sha256.h"
	.file 13 "<built-in>"
